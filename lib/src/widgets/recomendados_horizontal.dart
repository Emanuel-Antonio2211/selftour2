...
class ToursRecomendados extends StatefulWidget {
  final List<InfoTour> listaRecomendados;
  ToursRecomendados({@required this.listaRecomendados});
  @override
  _ToursRecomendadosState createState() => _ToursRecomendadosState();
}

class _ToursRecomendadosState extends State<ToursRecomendados> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: PageView.builder(
        ...
        itemCount: 4,//widget.listaRecomendados.length
        itemBuilder: (context,i){
          return recomendados(context, widget.listaRecomendados[i]);
        },
      ),
    );
  }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    tourRecomendado.title==null ? '':tourRecomendado.title,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontFamily: 'Point-SemiBold'),
                  ),
                  Text(
                    tourRecomendado.country==null ? '':tourRecomendado.country,//
                    style: TextStyle(fontFamily: 'Point-SemiBold'),
                  ),
                  /*FutureBuilder(
                    future: translator.translate(tourRecomendado.country,to: prefs.idioma == null ? 'es':prefs.idioma.toString()),
