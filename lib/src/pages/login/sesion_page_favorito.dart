...
class SesionPageFavorito extends StatefulWidget {
  @override
    ...
    return StreamBuilder(
      ...
      if (!snapshot.hasData || snapshot.hasError) {
       ...
       //String foto = 'assets/iconoapp/Selftour1.png';
        ...
        //ChatPage(userId: detalleTour.iduser.toString(),userName: detalleTour.name,userAvatar: 'https://fotos00.levante-emv.com/mmp/2018/11/20/328x206/errores-sacar-fotos.jpg');
        }
      },
    );
  }
